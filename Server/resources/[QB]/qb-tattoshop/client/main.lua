...
Citizen.CreateThread(function()
    for k, v in pairs (Config.Blips) do
            local clothingShop = AddBlipForCoord(Config.Blips[k].x, Config.Blips[k].y, Config.Blips[k].z)
            SetBlipSprite(clothingShop, 362)
            SetBlipColour(clothingShop, 7)
...
--     while true do
--     for k, v in pairs(Config.Blips) do
--             local _blip = AddBlipForCoord(Config.Blips.x, Config.Blips.y, Config.Blips.z)
--             SetBlipSprite(_blip, 1)
--             SetBlipDisplay(_blip, 4)
--             SetBlipScale(_blip, 0.5)
