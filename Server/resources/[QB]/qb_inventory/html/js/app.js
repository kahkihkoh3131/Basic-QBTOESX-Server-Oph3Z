...
function FormatAttachmentInfo(data) {
    $.post("http://qb_inventory/GetWeaponData", JSON.stringify({
        ...
        $(".weapon-attachments-container-details").html('<span style="font-Ağırlık: bold; letter-spacing: .1vh;">Seri Numarası</span><br> ' + ClickedItemData.info.serie + '<br><br><span style="font-Ağırlık: bold; letter-spacing: .1vh;">Dayanıklılık - ' + Durability.toFixed(2) + '% </span> <div class="weapon-attachments-container-detail-durability"><div class="weapon-attachments-container-detail-durability-total"></div></div>')
...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "wallet") {
            var gender = "Erkek";
            if (itemData.info.gender == 1) {
                gender = "Kadın";
            }
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Ad: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Soyad: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Dogum T.: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Cinsiyet: </strong><span>' + gender + '</span></p><p><strong>Boy: </strong><span>' + itemData.info.nationality + '</span></p>');
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html('<p><strong>Seri Numarası: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Cephane: </strong><span>' + itemData.info.ammo + '</span></p><p>' + itemData.description + '</p> <p><strong>Dayanıklılık: </strong><span>' + itemData.info.quality.toFixed(2) + '</span></p>');
            }
        ...
        if((toData != undefined || toData != null) && toData.name == fromData.name && !fromData.unique) {
            ...
            if (fromData.count == $toAmount) {
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    ...
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p> <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + newData.image + '" alt="' + newData.name + '" /></div><div class="item-slot-amount"><p>' + newData.count + ' (' + ((newData.weight * newData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                } else {
                ...
                if ((newData.name).split("_")[0] == "weapon") {
                    if (!Inventory.IsWeaponBlocked(newData.name)) {
                        ...
                        if (newData.info.quality !== undefined) {
                            qualityLabel = (newData.info.quality).toFixed(2);
                        } else {
                ...
                if ($fromInv.attr("data-inventory").split("-")[0] == "itemshop") {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        ...
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p> <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + newDataFrom.image + '" alt="' + newDataFrom.name + '" /></div><div class="item-slot-amount"><p>' + newDataFrom.count + ' (' + ((newDataFrom.weight * newDataFrom.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    } else {
                    ...
                    if ((newDataFrom.name).split("_")[0] == "weapon") {
                        if (!Inventory.IsWeaponBlocked(newDataFrom.name)) {
                            ...
                            if (newDataFrom.info.quality !== undefined) {
                                qualityLabel = (newDataFrom.info.quality).toFixed(2);
                            } else {
            ...
            if (fromData.count == $toAmount) {
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    ...
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p> <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + fromData.image + '" alt="' + fromData.name + '" /></div><div class="item-slot-amount"><p>' + fromData.count + ' (' + ((fromData.weight * fromData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                } else {
                ...
                if ((fromData.name).split("_")[0] == "weapon") {
                    if (!Inventory.IsWeaponBlocked(fromData.name)) {
                        ...
                        if (fromData.info.quality !== undefined) {
                            qualityLabel = (fromData.info.quality).toFixed(2);
                        } else {
                ...
                if (toData != undefined) {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        ...
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p> <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + toData.image + '" alt="' + toData.name + '" /></div><div class="item-slot-amount"><p>' + toData.count + ' (' + ((toData.weight * toData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    } else {
                    ...
                    if ((toData.name).split("_")[0] == "weapon") {
                        if (!Inventory.IsWeaponBlocked(toData.name)) {
                            ...
                            if (toData.info.quality !== undefined) {
                                qualityLabel = (toData.info.quality).toFixed(2);
                            } else {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        ...
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p> <i class="fas fa-lock"></i></p></div><div class="item-slot-img"></div><div class="item-slot-label"><p>&nbsp;</p></div>');
                    } else {
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-img"></div><div class="item-slot-label"><p>&nbsp;</p></div>');
                    }
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    ...
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p> <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + newDataTo.image + '" alt="' + newDataTo.name + '" /></div><div class="item-slot-amount"><p>' + newDataTo.count + ' (' + ((newDataTo.weight * newDataTo.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                } else {
                ...
                if ((newDataTo.name).split("_")[0] == "weapon") {
                    if (!Inventory.IsWeaponBlocked(newDataTo.name)) {
                        ...
                        if (newDataTo.info.quality !== undefined) {
                            qualityLabel = (newDataTo.info.quality).toFixed(2);
                        } else {
...
(() => {
    ...
    Inventory.Open = function(data) {
        totalWeight = 0;
        totalWeightOther = 0;
        $("#player-inv-label").html('Oyuncu-'+ data.id)
        ...
        for(i = 6; i < (data.slots + 1); i++) {
            if (i == 41) {  // Kilitli slot bak bu haberin olsun
                // $(".player-inventory").append('<div class="item-slot" data-slot="' + i + '"><div class="item-slot-key"><p> <i class="fas fa-lock"></i></p></div><div class="item-slot-img"></div><div class="item-slot-label"><p>&nbsp;</p></div></div>');
            } else {
                ...
                if (item != null) {
                    ...
                    if (item.slot < 6) {
                        ...
                        if (item.name == "cash") {
                            ...
                            $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p> <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                        }
                    } else {
                        if (item.name == "cash") {
    ...
    Inventory.ToggleHotbar = function(data) {
        if (data.open) {
            ...
            var elem = '<div class="z-hotbar-item-slot" data-zhotbarslot="41"> <div class="z-hotbar-item-slot-key"><p> <i class="fas fa-lock"></i></p></div><div class="z-hotbar-item-slot-img"></div><div class="z-hotbar-item-slot-label"><p>&nbsp;</p></div></div>'
            $.each(data.items, function(i, item){
                if (item != null) {
                    ...
                    if (item.name == "cash") {
                        $(".z-hotbar-inventory").find("[data-zhotbarslot=" + item.slot + "]").html('<div class="z-hotbar-item-slot-key"><p>' + item.slot + '</p></div><div class="z-hotbar-item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="z-hotbar-item-slot-amount"><p>$' + item.count + '</p></div><div class="item-slot-label"><p>' + item.label + '</p></div>');
                    } else {
    ...
    Inventory.itemBox = function(data) {
        ...
        var type = "1x Kullanıldı"
        if (data.type == "add") {
            type = data.count +'x' +  " Eklendi";
        } else if (data.type == "remove") { 
            type = data.count +'x' +  " Silindi";
