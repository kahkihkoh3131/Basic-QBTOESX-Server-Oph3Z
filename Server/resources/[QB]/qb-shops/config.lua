...
Config.Shops = { 
  ...
  ['Silahçı'] = {
    ...
    coords = {
        ...
        vector3(251.99, -49.82, 69.94),
        vector3(-662.32, -935.23, 21.83),
        vector3(810.05, -2156.93, 29.62),
        vector3(2567.76,294.63,108.74),
        vector3(1693.83,3759.77,34.81),
        vector3(-1117.45,2698.58,18.55),
        vector3(-330.24,6083.88,31.55),
    },
    Shop = {
    items = {
        [1] = { name = "weapon_pistol", price = 1, count = 100,  info = {},  type = "weapon", slot = 1, },
